...
namespace Portal.ImageCropServices
{
    ...
    internal class ScopedProccesingService : IScopedProcessingService
    {
        private readonly ILogger _logger;
        private readonly ImageDbContext _db;

        public ScopedProccesingService(ILogger<ScopedProccesingService> logger, ImageDbContext db)
        {
            _logger = logger;
            _db = db;
        }
